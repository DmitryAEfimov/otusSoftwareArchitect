...
import ru.otus.softwarearchitect.defimov.inventory.controller.exception.NetworkElementChangeException;
import ru.otus.softwarearchitect.defimov.inventory.controller.exception.NetworkElementNotFoundException;
...
@Timed(value = "inventory",
		histogram = true)
public class NetworkElementCrudRequestController {
	private final NetworkElementRepository neRepository;
	private final LocationRepository locationRepository;
	private final MessageSource messageSource;

	public NetworkElementCrudRequestController(NetworkElementRepository deviceRepository,
